...
pwd
echo "Compress..."
./dat2 palette.bmp vespino.pcx vespino2.pcx vespino3.pcx HEAD.PCX bege.pcx main*.pcx enem*.pcx tiles.pcx bg*.tmx LIVES.PCX LIFEBAR.PCX GIRL.PCX KEY.PCX BLUE_KEY.PCX ROGERR.MID alleycat.mid ALLEY.PCX CHEESE.PCX HEART.PCX CLOTHES*.PCX cat*.PCX dog*.PCX BINCAT.PCX PHONE.PCX alleytheme.wav hit.wav dog.wav punch.wav punch2.wav fall.wav die.wav shareware.txt levels.csv
